...
/** NOTE: diagnoseSdkConnectivity は現時点で @sentry/nextjs からは直接エクスポートされていないため、
 * ESLint(import/namespace) エラーを避ける目的で @sentry/browser から明示的にインポートしています。
 * 将来的に @sentry/nextjs 側で統一的にエクスポートされれば、そちらに切り替える予定です。
 */
...
export default function Page() {
  ...
  useEffect(() => {
    async function checkConnectivity() {
      // Sentry SDKと eslint-import-pluginの
    ...
    <div>
      ...
      <main>
        ...
        <p className="">
          ...
          <a
            target="_blank"
            href="https://hiroya-nakano.sentry.io/issues/?project=4509398322577409"
            rel="noreferrer"
          >
            Issues Page
          </a>
        ...
        {hasSentError ? (
          <p className="">Sample error was sent to Sentry.</p>
        ) : !isConnected ? (
          <div className="">
            <p>
