      ...
      <div className="col-span-3 grid grid-cols-custom-layout gap-layout-gap">
        <div className="col-start-2 grid min-h-dvh grid-cols-1 grid-rows-[auto_1fr] md:grid-cols-[200px_1fr] md:grid-rows-[auto_1fr_auto] md:gap-6">
          <LayoutHeader
            ...
            isUserProfile={true}
          />
          <main className="col-start-1 col-end-3 row-start-2 row-end-3 mt-8 grid grid-rows-[auto_1fr] gap-y-6 md:col-start-2 md:row-start-2 md:mt-0 md:py-0 md:pb-24">
            <Breadcrumbs />
            {children}
          </main>
