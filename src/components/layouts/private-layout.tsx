  ...
  return (
    <div className="grid grid-cols-custom-layout bg-custom-gradient">
      <div className="col-span-3 grid grid-cols-custom-layout gap-layout-gap">
        <div className="col-start-2 grid min-h-dvh grid-cols-1 grid-rows-[100px_1fr_auto] md:grid-cols-[200px_1fr] md:gap-6">
          <LayoutHeader
            className="z-30 col-start-1 col-end-3 mt-6"
            isUserProfile={true}
          />
          <main className="col-start-2 col-end-3 row-start-3 pb-24 pt-12 md:col-start-2 md:row-start-2 md:py-0">
            {children}
          </main>
          <LayoutAside className="fixed top-32 col-start-1 col-end-2 row-start-2 row-end-3" />
